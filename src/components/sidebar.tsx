    ...
    <aside className="absolute left-0 top-0 h-screen w-[250px]">
      <div className="flex h-full flex-col justify-between p-5 text-center">
        <div className="flex flex-col items-center gap-2">
          <div className="relative aspect-square w-full overflow-hidden rounded-full border-8 border-gray-800">
        ...
        <ul className="flex flex-col gap-4">
          <li className="cursor-pointer select-none duration-200 hover:text-highlight">Home</li>
          <li className="cursor-pointer select-none duration-200 hover:text-highlight">About Me</li>
          <li className="cursor-pointer select-none duration-200 hover:text-highlight">Resume</li>
          <li className="cursor-pointer select-none duration-200 hover:text-highlight">
            Portfolio
          </li>
        </ul>
